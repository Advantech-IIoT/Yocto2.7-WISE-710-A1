...
if [ -d ../sources/meta-wise710a1-warrior ]; then
  echo "BBLAYERS += \" \${BSPDIR}/sources/meta-wise710a1-warrior \"" >> $BUILD_DIR/conf/bblayers.conf
  if [ -d ../sources/meta-wise710a1-warrior/meta-bsp-patch ]; then
    echo "BBLAYERS += \" \${BSPDIR}/sources/meta-wise710a1-warrior/meta-bsp-patch \"" >> $BUILD_DIR/conf/bblayers.conf
  fi
fi
