...
#define EAPI_ID_HWMON_VOLTAGE_MAX            23                                  /* Maximum voltage item number */
...
/*WISE-710 ID to GPIO Mapping*/
#define EAPI_WISE710_EXT_DI_ID(DI_NUM)    EAPI_UINT32_C(DI_NUM)

#define EAPI_WISE710_EXT_ID_DI_DI00     EAPI_WISE710_EXT_DI_ID(4) /* (Optional) */
#define EAPI_WISE710_EXT_ID_DI_DI01     EAPI_WISE710_EXT_DI_ID(5) /* (Optional) */
#define EAPI_WISE710_EXT_ID_DI_DI02     EAPI_WISE710_EXT_DI_ID(6) /* (Optional) */
#define EAPI_WISE710_EXT_ID_DI_DI03     EAPI_WISE710_EXT_DI_ID(7) /* (Optional) */
#define EAPI_WISE710_EXT_ID_DI_DI04     EAPI_WISE710_EXT_DI_ID(8) /* (Optional) */
#define EAPI_WISE710_EXT_ID_DI_DI05     EAPI_WISE710_EXT_DI_ID(9) /* (Optional) */

#define EAPI_WISE710_EXT_DO_ID(DO_NUM)    EAPI_UINT32_C(DO_NUM)

#define EAPI_WISE710_EXT_ID_DO_DO00     EAPI_WISE710_EXT_DO_ID(4) /* (Optional) */
#define EAPI_WISE710_EXT_ID_DO_DO01     EAPI_WISE710_EXT_DO_ID(5) /* (Optional) */
#define EAPI_WISE710_EXT_ID_DO_DO02     EAPI_WISE710_EXT_DO_ID(6) /* (Optional) */
#define EAPI_WISE710_EXT_ID_DO_DO03     EAPI_WISE710_EXT_DO_ID(7) /* (Optional) */

#define EAPI_WISE710_EXT_AI_ID(AI_NUM)    EAPI_UINT32_C(AI_NUM)


#define EAPI_WISE710_EXT_ID_AI_AI00     EAPI_WISE710_EXT_AI_ID(0) /* (Optional) */
#define EAPI_WISE710_EXT_ID_AI_AI01     EAPI_WISE710_EXT_AI_ID(1) /* (Optional) */
#define EAPI_WISE710_EXT_ID_AI_AI02     EAPI_WISE710_EXT_AI_ID(2) /* (Optional) */
#define EAPI_WISE710_EXT_ID_AI_AI03     EAPI_WISE710_EXT_AI_ID(3) /* (Optional) */
#define EAPI_WISE710_EXT_ID_AI_AI04     EAPI_WISE710_EXT_AI_ID(4) /* (Optional) */
#define EAPI_WISE710_EXT_ID_AI_AI05     EAPI_WISE710_EXT_AI_ID(5) /* (Optional) */
#define EAPI_WISE710_EXT_ID_AI_AI06     EAPI_WISE710_EXT_AI_ID(6) /* (Optional) */
#define EAPI_WISE710_EXT_ID_AI_AI07     EAPI_WISE710_EXT_AI_ID(7) /* (Optional) */
